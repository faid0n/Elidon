...
HD_PWD='C:/Users/faido/Documents/My Documents/ECE/Semester 6/Advanced Computer Architecture/Elidon/Vivado Project/Vivado Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Elidon.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Elidon.tcl
